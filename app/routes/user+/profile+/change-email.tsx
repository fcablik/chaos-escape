...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'chaos escape email changed',
...
export async function action({ request }: DataFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `chaos escape Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>chaos escape Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your chaos escape email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your chaos escape email has been
						changed.
					</E.Text>
				</p>
				<p>
